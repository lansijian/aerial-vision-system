...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ...
        if time_usage > 600:
            ...
            while True:
                pass
        if time_usage > print_time_flag and time_usage < print_time_flag + 1 and print_time_flag2:
            print("Time Usage %d"%print_time_flag)
            print_time_flag2 = False
        elif time_usage > print_time_flag + 1:
            print_time_flag += 1
            print_time_flag2 = True
        ...
        cv2.putText(background,"Score: "+str(int(score)) ,(60,25),cv2.FONT_HERSHEY_SIMPLEX,0.75,(0,0,0),2)
        cv2.putText(background,"Time usage: "+str(int(time_usage)) ,(360,25),cv2.FONT_HERSHEY_SIMPLEX,0.75,(0,0,0),2)
        cv2.putText(background,"Left targets: "+str(list(left_actors)) ,(760,25),cv2.FONT_HERSHEY_SIMPLEX,0.75,(0,0,0),2)
