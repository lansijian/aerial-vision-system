...
区域划分
**UAV1_R1**: x ∈ [-45, 25], y ∈ [-48.7, -15] - 左下区域
**UAV2_R2**: x ∈ [25, 87.5], y ∈ [-48.7, -15] - 中下区域  
**UAV3_R3**: x ∈ [87.5, 120], y ∈ [-48.7, -15] - 右下区域
**UAV4_R4**: x ∈ [-45, 25], y ∈ [-15, 49.2] - 左上区域
**UAV5_R5**: x ∈ [25, 87.5], y ∈ [-15, 49.2] - 中上区域
**UAV6_R6**: x ∈ [87.5, 120], y ∈ [-15, 49.2] - 右上区域
...
# 9 个街道转弯处坐标 (x, y, z)
intersections = [
    (-15, -45, 0.01), (65, -45, 0.01), (110, -45, 0.01),
    (-15, 0, 0.015), (65, 0, 0.015), (110, 0, 0.015),
    (-15, 45, 0.015), (65, 45, 0.015), (110, 45, 0.015)
]
...
regions = {
    "UAV1_R1": (-45, 25, -48.7, -15),
    "UAV2_R2": (25, 87.5, -48.7, -15),
    "UAV3_R3": (87.5, 120, -48.7, -15),
    "UAV4_R4": (-45, 25, -15, 49.2),
    "UAV5_R5": (25, 87.5, -15, 49.2),
    "UAV6_R6": (87.5, 120, -15, 49.2)
}
