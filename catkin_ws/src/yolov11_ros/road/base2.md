...
**UAV2_R2**: x ∈ [10, 80], y ∈ [-48.7, -15] - 中下区域  
**UAV3_R3**: x ∈ [80, 120], y ∈ [-48.7, -15] - 右下区域
**UAV4_R4**: x ∈ [-45, 10], y ∈ [-15, 49.2] - 左上区域
**UAV5_R5**: x ∈ [10, 80], y ∈ [-15, 49.2] - 中上区域
**UAV6_R6**: x ∈ [80, 120], y ∈ [-15, 49.2] - 右上区域
...
regions = {
    ...
    "UAV2_R2": (10, 80, -48.7, -15),
    "UAV3_R3": (80, 120, -48.7, -15),
    "UAV4_R4": (-45, 10, -15, 49.2),
    "UAV5_R5": (10, 80, -15, 49.2),
    "UAV6_R6": (80, 120, -15, 49.2)
}
