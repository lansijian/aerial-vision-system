...
**road_y_3**: x = 55-75, y ∈ [-48.7, 49.2] (斜向道路)
...
**UAV2_R2**: x ∈ [20, 92.5], y ∈ [-48.7, -15] - 中下区域  
**UAV3_R3**: x ∈ [92.5, 120], y ∈ [-48.7, -15] - 右下区域
**UAV4_R4**: x ∈ [-45, 20], y ∈ [-15, 49.2] - 左上区域
**UAV5_R5**: x ∈ [20, 92.5], y ∈ [-15, 49.2] - 中上区域
...
regions = {
    ...
    "UAV2_R2": (20, 92.5, -48.7, -15),
    "UAV3_R3": (92.5, 120, -48.7, -15),
    "UAV4_R4": (-45, 20, -15, 49.2),
    "UAV5_R5": (20, 92.5, -15, 49.2),
