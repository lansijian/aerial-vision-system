...
区域划分
**UAV1_R1**: x ∈ [-45, 15], y ∈ [-48.7, -15] - 左下区域
**UAV2_R2**: x ∈ [15, 77.5], y ∈ [-48.7, -15] - 中下区域  
**UAV3_R3**: x ∈ [77.5, 120], y ∈ [-48.7, -15] - 右下区域
**UAV4_R4**: x ∈ [-45, 15], y ∈ [-15, 49.2] - 左上区域
**UAV5_R5**: x ∈ [15, 77.5], y ∈ [-15, 49.2] - 中上区域
**UAV6_R6**: x ∈ [77.5, 120], y ∈ [-15, 49.2] - 右上区域
...
regions = {
    "UAV1_R1": (-45, 15, -48.7, -15),
    "UAV2_R2": (15, 77.5, -48.7, -15),
    "UAV3_R3": (77.5, 120, -48.7, -15),
    "UAV4_R4": (-45, 15, -15, 49.2),
    "UAV5_R5": (15, 77.5, -15, 49.2),
    "UAV6_R6": (77.5, 120, -15, 49.2)
}
