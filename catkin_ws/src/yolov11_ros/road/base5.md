...
**road_y_3**: x = 30, y ∈ [-48.7, 49.2]
**road_y_4**: x = 110, y ∈ [-48.7, 49.2]
**road_y_5**: x = 120, y ∈ [-48.7, 49.2]

水平道路 (X方向)
**road_x_1**: y = -45, x ∈ [-41.3, 116.3]
**road_x_2**: y = 10, x ∈ [-41.3, 111.3] (特殊道路)
**road_x_3**: y = 45, x ∈ [-41.3, 116.3]
**road_x_4**: y = 11, x ∈ [111.3, 116.3] (连接道路)

12个街道转弯处坐标 (x, y, z)
1. **I1**: (-15, -45, 0.01) - road_y_2 与 road_x_1 交点
2. **I2**: (30, -45, 0.01) - road_y_3 与 road_x_1 交点  
3. **I3**: (110, -45, 0.01) - road_y_4 与 road_x_1 交点
4. **I4**: (-15, 10, 0.015) - road_y_2 与 road_x_2 交点
5. **I5**: (30, 10, 0.015) - road_y_3 与 road_x_2 交点
6. **I6**: (110, 10, 0.015) - road_y_4 与 road_x_2 交点
7. **I7**: (-15, 45, 0.015) - road_y_2 与 road_x_3 交点
8. **I8**: (30, 45, 0.015) - road_y_3 与 road_x_3 交点
9. **I9**: (110, 45, 0.015) - road_y_4 与 road_x_3 交点
10. **I10**: (110, 11, 0.015) - road_y_4 与 road_x_4 交点
11. **I11**: (120, 11, 0.015) - road_y_5 与 road_x_4 交点
12. **I12**: (120, 45, 0.015) - road_y_5 与 road_x_3 交点
...
区域划分
**UAV1_R1**: x ∈ [-45, 7.5], y ∈ [-48.7, -15] - 左下区域
**UAV2_R2**: x ∈ [7.5, 70], y ∈ [-48.7, -15] - 中下区域  
**UAV3_R3**: x ∈ [70, 120], y ∈ [-48.7, -15] - 右下区域
**UAV4_R4**: x ∈ [-45, 7.5], y ∈ [-15, 49.2] - 左上区域
**UAV5_R5**: x ∈ [7.5, 70], y ∈ [-15, 49.2] - 中上区域
**UAV6_R6**: x ∈ [70, 120], y ∈ [-15, 49.2] - 右上区域
...
**UAV6_R6**: 覆盖 road_y_4, road_y_5, road_x_2, road_x_3, road_x_4 部分
...
# 12 个街道转弯处坐标 (x, y, z)
intersections = [
    (-15, -45, 0.01), (30, -45, 0.01), (110, -45, 0.01),
    (-15, 10, 0.015), (30, 10, 0.015), (110, 10, 0.015),
    (-15, 45, 0.015), (30, 45, 0.015), (110, 45, 0.015),
    (110, 11, 0.015), (120, 11, 0.015), (120, 45, 0.015)
]
...
regions = {
    "UAV1_R1": (-45, 7.5, -48.7, -15),
    "UAV2_R2": (7.5, 70, -48.7, -15),
    "UAV3_R3": (70, 120, -48.7, -15),
    "UAV4_R4": (-45, 7.5, -15, 49.2),
    "UAV5_R5": (7.5, 70, -15, 49.2),
    "UAV6_R6": (70, 120, -15, 49.2)
}
